...
<table>
  <tr>
    <td><strong>Input (Wine Label Photo)</strong></td>
    <td><strong>Output (Generated Journal Entry)</strong></td>
  </tr>
  <tr>
    <td><img src="testing_images/wine1.jpg" alt="Sample Wine Label" width="300"/></td>
    <td><img src="readme_images/fallback_image.png)" alt="Generated Journal Entry" width="400"/></td>
  </tr>
</table>

![Fallback Image](readme_images/fallback_image.png)
